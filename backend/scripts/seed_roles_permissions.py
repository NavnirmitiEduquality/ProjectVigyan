...
PERMISSIONS = [
    ...
    ("Delete Session TLM", "session_tlm.delete", "session_tlm"),
        ...
        # Session Evidence
    ("View Session Evidence", "session_evidence.view", "session_evidence"),
    ("Record Session Evidence", "session_evidence.create", "session_evidence"),
    ("Update Session Evidence", "session_evidence.update", "session_evidence"),
    ("Delete Session Evidence", "session_evidence.delete", "session_evidence"),
...
ROLE_PERMISSIONS = {
    ...
    "SYSTEM_ADMIN": {
        ...
        "session_tlm.update",
        "session_tlm.delete",
        "session_evidence.view",
        "session_evidence.create",
